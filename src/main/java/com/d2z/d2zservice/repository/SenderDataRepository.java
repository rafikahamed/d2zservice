...
public interface SenderDataRepository extends CrudRepository<SenderdataMaster, Long>{
	...
	@Query(nativeQuery = true, value="Select reference_number, datamatrix, articleId, BarcodelabelNumber from senderdata_master t where sender_Files_ID=:senderFileID") 
