...
@RestController
@RequestMapping(value = "/v1/speedcouriers/superUser-level")
public class SPCourierSuperUserController {

	Logger logger = LoggerFactory.getLogger(SPCourierSuperUserController.class);
	...
	/*
	 * @RequestMapping( method = RequestMethod.GET, path = "/export/delete") public
	 * List<SenderdataMaster> exportDeteledConsignments(@RequestParam("fromDate")
	 * String fromDate,@RequestParam("toDate") String toDate) { return
	 * superUserD2zService.exportDeteledConsignments(fromDate, toDate); }
	 */
	@RequestMapping(method = RequestMethod.GET, path = "/export/delete")
	public List<ExportDelete> exportDeteledConsignments(@RequestParam("fromDate") String fromDate,
	...
	public List<ExportShipment> exportShipmentData(@RequestParam("fromDate") String fromDate,
			@RequestParam("toDate") String toDate) {
	...
	public List<ExportShipment> exportNonShipmentData(@RequestParam("fromDate") String fromDate,
			@RequestParam("toDate") String toDate) {
	...
	public List<DownloadInvice> downloadInvoice(@RequestParam("broker") List<String> broker,
			@RequestParam("airwayBill") List<String> airwayBill, @RequestParam("billed") String billed,
			@RequestParam("invoiced") String invoiced) {
	...
	public List<DownloadInvice> downloadNonD2zInvoice(@RequestParam("broker") List<String> broker,
			@RequestParam("airwayBill") List<String> airwayBill, @RequestParam("billed") String billed,
			@RequestParam("invoiced") String invoiced) {
	...
	public UserMessage fetchNonD2zClient(@RequestBody List<NonD2ZData> nonD2zData)
			throws ReferenceNumberNotUniqueException {
