...
public class D2zBrokerController {
    ...
    public List<ShipmentDetails> directInjection(@RequestParam("companyName") String companyName) {
		List<ShipmentDetails> senderData = brokerD2zService.directInjection(companyName);
    	return senderData;
    }
